<?php		
		...
		if (isset($_POST['submitdataptn'])) {
			if(isset($_POST['prodireg1'])) {
				...
				//header('location: get_tryout.php');
			    //exit;
				//echo "".$_POST['prodi1'] ."\n";
			} 
			...
			if($result) $isprodiReg1Exist=mysqli_fetch_array($result)['prodi'];
			...
			$sql = "UPDATE pilihanprodi SET prodireg1='$prodireg1', prodireg2='$prodireg2', prodireg3='$prodireg3', 
									prodipar1='$prodipar1', prodipar2='$prodipar2', prodipar3='$prodipar3', 
									prodivok1='$prodivok1', prodivok2='$prodivok2', prodivok3='$prodivok3',
									type='Soshum' WHERE userid='$username'";			
			//mysqli_query($conn, $sql);
			if (mysqli_query($conn, $sql)) {	
            	header('location: ks-test-instructions.php');
            	exit;
			} else {
            ...
            <div class="py-4 px-3 px-md-4">
                ...
                <div class="row align-items-center mb-3 mb-xl-3">
                    <div class="col-xl-6 center mb-2 mb-md-0">
                      <h1 class="h3">Pilih Prodi</h1>
                      <em>Kemampuan IPS (KS)</em>
                    </div>
                  </div>
                <div class="row">
            ...
            <div class="col-xl-6 center">
              ...
              <div class="card mb-3 mb-md-4">
                ...
                <div class="card-body pt-0">
                  <h6 class="font-weight-semi-bold mb-3">Reguler</h6>
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Reguler 1"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Reguler 2"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Reguler 3"
                            data-classes="select select-bordered rounded" name="prodireg3" id="prodireg3">

                      <option value=""
                              data-option-template='<span class="d-flex align-items-center"><i>Prodi Reguler 3</i></span>'>---</option>
                  ...
                  <h6 class="font-weight-semi-bold mb-3">Paralel</h6>
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Paralel 1"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Paralel 2"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Paralel 3"
                            data-classes="select select-bordered rounded" name="prodipar3" id="prodipar3">

                      <option value=""
                              data-option-template='<span class="d-flex align-items-center"><i>Prodi Paralel 3</i></span>'>---</option>
                             ...
                             <h6 class="font-weight-semi-bold mb-3">Vokasi</h6>
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Vokasi 1"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Vokasi 2"
                  ...
                  <div class="mb-3 mb-md-4">
                    <select class="js-custom-select" style="width: 100%;"
                            data-placeholder="Pilih Prodi Vokasi 3"
                            data-classes="select select-bordered rounded" name="prodivok3" id="prodivok3">

                      <option value=""
                              data-option-template='<span class="d-flex align-items-center"><i>Prodi Vokasi 3</i></span>'>---</option>
    ...
    <script>
		...
		<script>
            ...
            window.SelectProdi = function(){
                console.log(mp_type);
//				document.getElementById("prodireg1");

                // removeAllOptions(document.getElementById("prodireg1"));
				// removeAllOptions(document.getElementById("prodireg2"));
				// removeAllOptions(document.getElementById("prodireg3"));
				// removeAllOptions(document.getElementById("prodipar1"));
				// removeAllOptions(document.getElementById("prodipar2"));
				// removeAllOptions(document.getElementById("prodipar3"));
				// removeAllOptions(document.getElementById("prodivok1"));
				// removeAllOptions(document.getElementById("prodivok2"));
				// removeAllOptions(document.getElementById("prodivok3"));
                //var selected_ptn = document.getElementById("select2-ptn" + ptn_type + "-container").innerHTML;
                //initProdiByJenjangSelectField(jenjang_type, mp_type, null);
				//initProdiByJenjangSelectField('Reguler', mp_type, null);
                //initProdiByJenjangSelectField('Paralel', mp_type, null);
                //initProdiByJenjangSelectField('Vokasi', mp_type, null);
				// initProdiByJenjangSelectField('Reguler', mp_type, 1);
				// initProdiByJenjangSelectField('Reguler', mp_type, 2);
				// initProdiByJenjangSelectField('Reguler', mp_type, 3);
                // initProdiByJenjangSelectField('Paralel', mp_type, 1);
