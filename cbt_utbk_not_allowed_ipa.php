                    ...
                    <div class="col-xl-6 mb-3 mb-xl-6 center" style="margin-top: 5rem;">
                        <div class="card mb-3 mb-md-4" style="border: 1px solid #eb7070;">
                            <div class="card-body" style="text-align: center">
                                ...
                                <br>
                            	<h5>Anda tidak diperkenankan untuk mengerjakan Tryout IPA.</h5>
                            	<h5>Karena pada Tryout Pertama Anda mengerjakan Tryout IPS.</h5>
                            	<h5>Silakan memilih Tryout IPS.</h5>
                                <br>
                                <h4>Good Luck! :)</h4>
                            </div>
