            ...
            <div class="py-4 px-3 px-md-4">
                ...
                <div class="row align-items-center mb-3 mb-xl-3">
                    <div class="col-md mb-2 mb-md-0">
                      <h1 class="h3 mb-5">Tes UTBK Pertama</h1>
                    </div>
                  </div>
        ...
        <div class="row">
              ...
              <div class="card">
                ...
                <div class="p-3 p-md-4 d-print-none">
                  ...
                  <div class="d-flex align-items-center">
                    <input type="submit" name="cbt_simakui_kd" class="btn btn-primary mr-2 center" value="Tes Potensi Skolastik (TPS)">
                  </div>
                </div>
              </div>
              <!-- End Card -->
            ...
            <div class="col-md-4 col-xl-4 mb-3 mb-md-4 center">
              ...
              <div class="card">
                ...
                <div class="p-3 p-md-4 d-print-none">
                  <div class="d-flex align-items-center">
                    <input type="submit" name="ka-test-instructions" class="btn btn-primary mr-2 center" value="Tes Kemampuan Akademik (TKA) Saintek">
                  </div>
                </div>
              </div>
              <!-- End Card -->
              ...
              <div class="card">
                ...
                <div class="p-3 p-md-4 d-print-none">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <input type="submit" name="ks-test-instructions" class="btn btn-primary mr-2 center" value="Tes Kemampuan Akademik (TKA) Soshum">
                  </div>
                </div>
              </div>
              <!-- End Card -->
