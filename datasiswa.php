...
<div id="service">
  <div class="container">
		<a href="add_siswa.php" class="btn btn-default smoothScroll" style="background-color:#ffd310;" >Tambah Data Siswa</a>
		<h2>Data Siswa </h2>
		...
		while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
			echo "<tr><td>". $number . "</td><td>". $row['userid'] . "</td><td>" . $row['name'] . "</td><td>" . $row['school'] .
			"</td><td>" . $row['class'] . "</td><td>" . $row['email'] ."</td><td>" . $row['phone'] .
			"</td><td>" . $row['nis'] . "</td><td>" . $row['nisn'] ."</td></tr>";  //$row['index'] the index here is a field name
			$number =  $number +1;
		} ?>
		</tbody>
		</table>
