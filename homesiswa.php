  ...
  <div class="container">
    <div class="row">
      <div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-6">
        ...
        <h1>Salemba Group <strong> Tryout CBT System</strong></h1>
        <p style="color:#fff;">Powered by : Sanggar Belajar</p>
        <a href="get_tryout.php" class="btn btn-default smoothScroll" style="background-color:#ffd310;" >GET STARTED</a></div>
    </div>
  </div>
</div>
