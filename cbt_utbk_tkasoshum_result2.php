...
//ini_set('max_execution_time', 0); 
	...
	$sql = "INSERT INTO  jawaban_tryout_ips2 (userid, name, school, class)
	...
	$sql = "UPDATE jawaban_tryout_ips2 SET jawabanips='$stringAnswer' WHERE userid='$username'";			
	...
	$sql = "INSERT INTO  hasil_tryout_ips2 (userid, name, school, class)
				VALUES ('$username', '$fullName', '$school', '$class')";
	if ($conn->query($sql) === TRUE) {
		//echo "New record created successfully";
	} else {
	...
	$sql = "UPDATE hasil_tryout_ips2 SET benar='$jawabanBenar', salah='$jawabanSalah', kosong='$jawabanKosong'  WHERE userid='$username'";				
	mysqli_query($conn, $sql);
		if (mysqli_query($conn, $sql)) {
