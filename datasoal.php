...
<div id="service">
  <div class="container">
		<a href="add_soal.php" class="btn btn-default smoothScroll" style="background-color:#ffd310;" >Tambah Data Soal</a>
		<h2>Data Soal </h2>
		...
		while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
			echo "<tr><td>". $row['id'] . "</td><td>" . $row['code'] . "</td><td>" . $row['subject'] .
			"</td><td>" . $row['degree'] . "</td><td>" . $row['description'] ."</td><td>" . $row['fileimage'] .
			"</td><td>" . $row['optionA'] . "</td><td>" . $row['optionB'] .
			"</td><td>" . $row['optionC'] . "</td><td>" . $row['optionD'] .
			"</td><td>" . $row['optionE'] . "</td><td>" . $row['flagOption'].
			"</td><td>" . $row['answer'] . "</td></tr>";  //$row['index'] the index here is a field name
			$number =  $number +1;
		}
		?>
		</tbody>
